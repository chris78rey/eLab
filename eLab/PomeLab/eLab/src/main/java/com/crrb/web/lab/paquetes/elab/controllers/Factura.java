...
public class Factura implements Serializable {
    ...
    public void buttonActionPrecio(ActionEvent actionEvent) {
        listClasif = findClasificadorPorDescripcion(clasifconvalores.getS());
...
//        System.out.println("facturaObj = " + facturaObj.getId());
    ...
    /**
     * @return the descuentoInputText
     */
    public Double getDescuentoInputText() {
        return descuentoInputText;
    }

    /**
     * @param descuentoInputText the descuentoInputText to set
     */
